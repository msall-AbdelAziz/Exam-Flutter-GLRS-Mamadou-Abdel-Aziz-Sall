...
import 'package:flutter_app_shop/widgets/provider_widget.dart';
...
class _SignUpViewState extends State<SignUpView> {
  ...
  List<Widget> buildButtons() {
    ...
    if (authFormType == AuthFormType.signIn) {
      _switchButtonText = "Nouveau compte";
      _newFormState = "signUp";
      _submitButtonText = "Connexion";
    } else {
      _switchButtonText = "Avoir un compte? Connexion";
